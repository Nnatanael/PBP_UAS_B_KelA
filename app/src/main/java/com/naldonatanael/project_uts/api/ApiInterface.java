...
public interface ApiInterface {
    ...
    @GET("booking/{id}")
    Call<BookingResponse> getKamarById(@Path("id")String id,
                                           @Query("data")String data);

    @PUT("booking/{id}")
    @FormUrlEncoded
    Call<BookingResponse> updateKamar(@Path("id")String id,
                                          @Field("nama")String nama, @Field("noTelp")String noTelp,
                                          @Field("jenisLayanan")String jenisLayanan, @Field("tglBook")String tglBook);
